    ...
    <div className="p-20 flex justify-center items-center min-h-screen bg-gray-50 px-4">
      ...
      >
        <h2 className="text-2xl  sm:text-3xl font-bold text-center">
          <span className="mr-2 bg-linear-to-r from-blue-500 to-blue-700 bg-clip-text text-transparent">
            MENTISERA
          </span>
          Login
        </h2>
        <input
          type="email"
          placeholder="Email"
          className="w-full p-3 sm:p-4 rounded-xl border border-gray-300 focus:border-blue-500 focus:outline-none"
          value={email}
        ...
        <div className="relative">
          <input
            ...
            className=" pr-10  px-3 py-2  w-full p-3 sm:p-4 rounded-xl border border-gray-300 focus:border-blue-500 focus:outline-none"
            value={password}
          ...
          <span
            className="absolute right-3 top-1/2 -translate-y-1/2 cursor-pointer text-gray-500 hover:text-blue-500 transition"
        ...
        <button className="w-full bg-linear-to-r from-blue-500 to-blue-700 text-white py-3 rounded-xl font-semibold hover:opacity-90">
          Login
        </button>
