...
const VerifyEmail = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen py-6 bg-gray-50">
      ...
      >
        <h2 className="text-2xl sm:text-3xl font-bold text-center bg-linear-to-r from-blue-500 to-blue-700 bg-clip-text text-transparent">
          Verify Email
        </h2>
          ...
          {otp.map((digit, index) => {
            return (
              <input
                ...
                type="text"
                placeholder="X"
                className="w-10 h-10 sm:w-12 sm:h-12 border-2   p-0 text-center font-bold text-xl sm:text-2xl rounded-xl border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 focus:outline-none"
                required
        ...
        <button
          type="submit"
          className="w-full bg-linear-to-r from-blue-500 to-blue-700 text-white py-3 rounded-xl font-semibold hover:opacity-90 text-sm sm:text-base"
        >
          Verify
        </button>
