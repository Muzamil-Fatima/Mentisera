      ...
      >
        ...
        <input
          ...
          className={`w-full p-3 rounded-xl border border-gray-300 focus:border-blue-500 focus:outline-none  ${
            isValidEmail === false ? "border-red-500" : "border-white-500"
          }`}
          value={inputEmail}
        ...
        <button
          disabled={loading}
          className="w-full bg-linear-to-r from-blue-500 to-blue-700 text-white py-3 rounded-xl font-semibold hover:opacity-90 flex items-center justify-center"
        >
