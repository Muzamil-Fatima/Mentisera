  ...
  const benefits = [
    {
      ...
      description:
        "You need verified trainers, and we provide them. Our complete background checks verify profiles, degrees, and credentials. You name it, we provide it, so you can hire with confidence.",
    },
    {
      id: 2,
      ...
      svg: (
        ...
        >
          <path
            d="M254,188V2H2v186h111v29H75v22h106v-22h-38v-29H254z M19,19h217v151H19L19,19z M80.092,81.292
	...
	c-23.507,0-21.764,19.926-21.764,19.926C89.183,99.004,85.556,90.289,85.556,80.726z"
      ...
      description:
        "Our smart algorithm connects you with the perfect consultant based on your unique project needs and goals.",
    },
    {
      id: 3,
      ...
      description:
        "Manage projects, track milestones, and communicate effortlessly through our integrated dashboard.",
    },
  ];
  return (
        ...
        {benefits.map((benefits, index) => {
          return (
            ...
            >
              ...
              <p className="text-center">{benefits.description}</p>
            </div>
          );
        })}
      </div>
