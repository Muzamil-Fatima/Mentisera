  ...
  return (
    <div className="bg-blue-950 text-white w-64 h-full p-2 flex flex-col justify-between">
      ...
      <div>
        ...
        <div className="w-full h-px bg-gray-300 opacity-75 mt-2 mb-2"></div>
        <div>
          <ul>
            {menuItems.map((item) => (
              <li
              ...
              >
                ...
                >
                  <span className="h-8 w-8 flex items-center justify-center text-white group-hover:text-black">
                    {item.svg}
                  </span>
      ...
      {/* Bottom Section */}
      <div>
        <div className="w-full h-px bg-gray-300 opacity-75 mb-2"></div>
        <div className="group mb-2 hover:bg-amber-50 rounded-xl text-white hover:text-black">
          <NavLink className="flex text-sm items-center gap-2 ">
            <span className="h-8 w-8 flex items-center justify-center text-white group-hover:text-black">
              <svg
                fill="currentColor"
                width="24px"
